...
(async () => {
  ...
  while (true) {
    ...
    try {
      ...
      const urls = [
        "https://kannaujattarr.com/products/first-rain-attar-12ml",
        "https://kannaujattarr.com/products/gulab-natural-attar-12ml",
        "https://kannaujattarr.com/products/shamama-attar-handcrafted-fragrance-from-kannauj",
      ];
